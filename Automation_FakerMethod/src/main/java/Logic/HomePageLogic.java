...
//    }
    public static void navigateToContactus() throws InterruptedException {
    	...
    	PhoneNumber phNO = faker.phoneNumber(); 
	...
	driver.findElement(HomePages.objorderreference).sendKeys(firstName);
		Thread.sleep(5000);
		driver.findElement(HomePages.objChooseFile).sendKeys("C:\\Users\\Hema\\OneDrive - Intact Green Services (India) PVT LTD\\Desktop\\Message.txt");
		Thread.sleep(5000);
		driver.findElement(HomePages.objMessage).sendKeys("This is automation test message");
		Thread.sleep(5000);
